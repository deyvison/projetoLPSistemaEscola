...
//Tirar os default depois
public class MenuSisaloca2Aprimorado {

	
	public static void main(String[] args) {
		
		SisalocaIF sisaloca = new Sisaloca();
		String opcaoInvalida,arqProfessores,arqDisciplinas,arqTurmas,arqPreferencias;
...
//										"Quarta.\n5 - Quinta.\n6 - Sexta.\n7 - Sábado"));
							...
							case 8:// voltar
								break;
							default:
								JOptionPane.showMessageDialog(null, opcaoInvalida, "Erro", JOptionPane.ERROR_MESSAGE);
